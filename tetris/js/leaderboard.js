...
const LEADERBOARD_ID = 'tetris-leaderboard';
const MAX_LEADERBOARD_ENTRIES = 10;
const LOCAL_STORAGE_KEY = 'tetrisPlayerName';
...
async function initLeaderboard() {
    console.log('Tetris Leaderboard: Starting initialization...');
    ...
    try {
        ...
        console.log('Tetris Leaderboard: DOM elements cached', {
        ...
        console.log('Tetris Leaderboard initialized');
    } catch (error) {
        console.error('Tetris Leaderboard initialization error:', error);
    }
}

async function refreshLeaderboardData() {
    try {
        console.log('Tetris Leaderboard: Loading data from TextDB...');
        const data = await load(LEADERBOARD_ID);
        console.log('Tetris Leaderboard: Data loaded', data);
...
function setupEventListeners() {
    ...
    console.log('Tetris Leaderboard event listeners set up');
}
